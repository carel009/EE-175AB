...
while True:
    ...
    k = cv2.waitKey(1)
    if decoded_data == "Picture \n":
        img_name = "Picture.png".format()
        cv2.imwrite(img_name, frame)
        print("Python: Picture taken! \n")
        break

    #elif decoded_data == "Picture \n":
        #img_name = "Picture.png".format()
        #cv2.imwrite(img_name, frame)
        #print("Python: Picture taken! \n")
...
def extract_num(img_filename):
    ...
    for (x, y, w, h) in nplate:
        ...
        if read == "KA05ME2190" or read == "" or read == "WA35E" or read == "KADSME2140" or read == "A05me7190l"\
                or read == "1a05ME2190":
            value = 'k'
        else:
            value = 't'
